..........................................FF............................ [ 49%]
............................s..............FFFFFFF....F.FF....FFFF.FF.FF [ 99%]
F                                                                        [100%]
================================== FAILURES ===================================
_ TestORBFilterExplanationAccuracy.test_0030_filter_explanation_matches_config _

self = <tests.strategy_presentation.test_strategy_explanation_accuracy.TestORBFilterExplanationAccuracy object at 0x000001EC57FD36A0>
...
E        +  where [0.112] = <built-in method get of dict object at 0x000001EC3C3E3E40>('0030')
E        +    where <built-in method get of dict object at 0x000001EC3C3E3E40> = {'0030': [0.112], '0900': [None], '1000': [None, None], '1100': [None], ...}.get
...
self = <tests.strategy_presentation.test_strategy_explanation_accuracy.TestORBFilterExplanationAccuracy object at 0x000001EC57FD39D0>
...
E        +  where [None, None] = <built-in method get of dict object at 0x000001EC3C3E3E40>('1000')
E        +    where <built-in method get of dict object at 0x000001EC3C3E3E40> = {'0030': [0.112], '0900': [None], '1000': [None, None], '1100': [None], ...}.get
E        +      where {'0030': [0.112], '0900': [None], '1000': [None, None], '1100': [None], ...} = config.MGC_ORB_SIZE_FILTERS
...
mock_db_connection = WindowsPath('C:/Users/sydne/AppData/Local/Temp/pytest-of-Josh/pytest-7/test_create_candidate0/test_edge.db')
...
mock_db_connection = WindowsPath('C:/Users/sydne/AppData/Local/Temp/pytest-of-Josh/pytest-7/test_approve_candidate0/test_edge.db')
...
E               ValueError: Edge candidate 57 not found

trading_app\edge_candidate_utils.py:149: ValueError
------------------------------ Captured log call ------------------------------
ERROR    edge_candidate_utils:edge_candidate_utils.py:172 Failed to approve candidate 57: Edge candidate 57 not found
_______________________ test_promote_approved_candidate _______________________

mock_db_connection = WindowsPath('C:/Users/sydne/AppData/Local/Temp/pytest-of-Josh/pytest-7/test_promote_approved_candidat0/test_edge.db')
...
candidate_id = 58, approver = 'Josh'
    ...
    def approve_edge_candidate(candidate_id: int, approver: str) -> None:
        ...
        try:
            ...
            if result is None:
>               raise ValueError(f"Edge candidate {candidate_id} not found")
E               ValueError: Edge candidate 58 not found

trading_app\edge_candidate_utils.py:149: ValueError
------------------------------ Captured log call ------------------------------
ERROR    edge_candidate_utils:edge_candidate_utils.py:172 Failed to approve candidate 58: Edge candidate 58 not found
_____________________ test_promote_fails_if_not_approved ______________________

mock_db_connection = WindowsPath('C:/Users/sydne/AppData/Local/Temp/pytest-of-Josh/pytest-7/test_promote_fails_if_not_appr0/test_edge.db')
...
------------------------------ Captured log call ------------------------------
ERROR    edge_pipeline:edge_pipeline.py:297 Failed to promote candidate 59: Binder Error: Referenced column "promoted_validated_setup_id" not found in FROM clause!
...
mock_db_connection = WindowsPath('C:/Users/sydne/AppData/Local/Temp/pytest-of-Josh/pytest-7/test_promote_fails_if_already_0/test_edge.db')
...
candidate_id = 60, approver = 'Josh'
    ...
    def approve_edge_candidate(candidate_id: int, approver: str) -> None:
        ...
        try:
            ...
            if result is None:
>               raise ValueError(f"Edge candidate {candidate_id} not found")
E               ValueError: Edge candidate 60 not found

trading_app\edge_candidate_utils.py:149: ValueError
------------------------------ Captured log call ------------------------------
ERROR    edge_candidate_utils:edge_candidate_utils.py:172 Failed to approve candidate 60: Edge candidate 60 not found
________________ test_promote_fails_if_missing_required_fields ________________

mock_db_connection = WindowsPath('C:/Users/sydne/AppData/Local/Temp/pytest-of-Josh/pytest-7/test_promote_fails_if_missing_0/test_edge.db')
...
mock_db_connection = WindowsPath('C:/Users/sydne/AppData/Local/Temp/pytest-of-Josh/pytest-7/test_no_hardcoded_placeholders0/test_edge.db')
...
candidate_id = 61, approver = 'Josh'
    ...
    def approve_edge_candidate(candidate_id: int, approver: str) -> None:
        ...
        try:
            ...
            if result is None:
>               raise ValueError(f"Edge candidate {candidate_id} not found")
E               ValueError: Edge candidate 61 not found

trading_app\edge_candidate_utils.py:149: ValueError
------------------------------ Captured log call ------------------------------
ERROR    edge_candidate_utils:edge_candidate_utils.py:172 Failed to approve candidate 61: Edge candidate 61 not found
...
self = <encodings.cp1252.IncrementalDecoder object at 0x000001EC59B69B10>
...
self = <test_config_generator.TestConfigLoading object at 0x000001EC58900DC0>
...
self = <test_config_generator.TestConfigLoading object at 0x000001EC58901000>
...
self = <test_config_generator.TestConfigLoading object at 0x000001EC58900DF0>
...
self = <test_config_generator.TestConfigLoading object at 0x000001EC58900F40>
...
self = <test_config_generator.TestOrbLookup object at 0x000001EC58816470>
...
self = <test_config_generator.TestOrbLookup object at 0x000001EC58815A50>
...
self = <test_config_generator.TestDatabaseSync object at 0x000001EC58814B20>
...
self = <test_config_generator.TestDatabaseSync object at 0x000001EC58900460>
...
self = <test_config_generator.TestDatabaseSync object at 0x000001EC58900970>
...
FAILED tests/test_edge_promotion.py::test_create_candidate - assert 56 == 1
