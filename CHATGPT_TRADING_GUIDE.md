...
2. **23:05+**: Wait for breakout (FIRST 1-MINUTE close OUTSIDE the range)
3. **Enter:** When FIRST 1-min candle closes above high (LONG) or below low (SHORT)
...
- Watch for FIRST 1-minute candle **close** outside the ORB (NOT 5-minute close!)
- **LONG:** 1-min close > ORB high
- **SHORT:** 1-min close < ORB low
...
- [ ] Filter PASSED
- [ ] FIRST 1-min candle closed OUTSIDE range
- [ ] Entry price = Close of 1-min breakout bar
...
### **DO NOT:**
- Enter before 1-min close confirms breakout
...
3. Breakout: FIRST 1-min close outside range
4. Entry: Close price of breakout 1-min bar
5. Stop: (High + Low) / 2
